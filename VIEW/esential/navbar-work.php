<!--1.1 Barra Navegacion -->
    <header>
        <nav class="navbar navbar-expand-lg navbar navbar-dark colorNav">
            <div class="container">
                <a class="navbar-brand" href="../VIEW/basepag.php">Trabaja a tu medida</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a class="nav-link" href="../VIEW/perfil.empresa.php" style="color:white;">
                        <img src="../CSS/open-iconic-master/png/person-3x.png" alt="persona">  <!--|  Entrar  |--->
                        Ir a perfil
                    </a>
                    <!-- *************** BUSCADOR
